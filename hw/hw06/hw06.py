...
class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            if self.price > self.money:
                deposit_short = self.price - self.money
                return 'You must deposit $' + str(deposit_short) + ' more.'
            elif self.price < self.money:
    ...
    def restock(self, number):
        assert number > 0,  'restock amount must greater than 0'
        self.stock += number
